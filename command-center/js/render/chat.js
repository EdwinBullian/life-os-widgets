...
<div class="chatwrap grow">
  <div class="chat-head"><span class="dot ok"></span><b>Assistant</b><span class="spacer"></span>
    <select style="width:auto"><optgroup label="Claude · Max"><option>Sonnet</option><option>Opus</option></optgroup><optgroup label="Open · gateway"><option>gpt-oss-20b</option></optgroup></select></div>
  <div class="chat-body">
